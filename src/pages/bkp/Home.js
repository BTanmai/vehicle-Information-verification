...
function Home() {
    return (
        <div style={{display:'flex',flexDirection:'column',placeItems:'center'}}>
            <Button  style={{maxWidth:'250px',marginLeft:'auto',color:'white',width:'250px',background:'linear-gradient(to right, #9C27B0, #E040FB)',border:0,marginRight:'auto',height:'50px',borderRadius:'5em',marginTop:'25vh',marginBottom:'50px'}}><Link to='/aadharSearch' style={{textDecoration:'none',color:'inherit'}}>Search by aadhar</Link></Button>
